const SPEAKER_AVATAR_RADIUS_M = 0.3;
...
const SPEAKER_RADIUS_M = 2;
const DRAW_SCALE = true;
...
const CIRCLE_LABEL_PADDING_PX = 20;
...
const ORIENTATION_CIRCLE_OFFSET_DIVISOR = 2;
const VIRTUAL_SPACE_DIMENSIONS_PER_SIDE_M = 5.5;
